# Filertest TypeScript MCP Server
...
```sh
git clone git@github.com:stainless-sdks/filertest-typescript.git
...
import { server, endpoints, init } from "filertest-mcp/server";

// import a specific tool
import getAssetPlatforms from "filertest-mcp/tools/asset-platforms/get-asset-platforms";
