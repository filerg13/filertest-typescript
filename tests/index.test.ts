...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['FILERTEST_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Filertest) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['FILERTEST_BASE_URL'] = undefined;
    });
    ...
    test('in request options overridden by client options', () => {
      const client = new Filertest({ proAPIKey: 'My Pro API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['FILERTEST_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Filertest({ proAPIKey: 'My Pro API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
