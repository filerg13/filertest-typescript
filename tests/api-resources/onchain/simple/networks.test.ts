...
describe('resource networks', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.onchain.simple.networks.retrieve('addresses', { network: 'eth' });
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.onchain.simple.networks.retrieve('addresses', {
      network: 'eth',
