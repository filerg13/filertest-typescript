...
export class TrendingPools extends APIResource {
   ...
   * ```ts
   * const pool =
   *   await client.onchain.networks.trendingPools.list('eth');
   * ```
   */
  list(
    network: string,
    query: TrendingPoolListParams | null | undefined = {},
...
export declare namespace TrendingPools {
  export { type Pool as Pool, type TrendingPoolListParams as TrendingPoolListParams };
}
